...
export default async function Showcase() {
  const categories = await getCategory('mobile-accessories')
  ...
  return (
    ...
    <div className="mx-auto w-full md:max-w-7xl px-4 py-16">
      <div className="md:flex md:items-center md:justify-between">
        ...
        <Link href="/category/mobile-accessories" className="hidden text-sm font-medium text-black hover:text-black md:block">
          Shop the collection
      ...
      <div className="mt-8 text-sm md:hidden">
        <Link href="/category/mobile-accessories" className="font-medium text-black hover:text-black">
          Shop the collection
          <span aria-hidden="true"> &rarr;</span>
        </Link>
      </div>
